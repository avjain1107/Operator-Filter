 ...
 */
contract MockOperatorFilterRegistry is
    IOperatorFilterRegistry,
    OperatorFilterRegistryEvents
{
    ...
    function subscriptionOf(
        address registrant
    ) external view override returns (address subscription) {
